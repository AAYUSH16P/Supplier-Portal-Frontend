...
export default function ContactContent({ isAuth }) {
  const navigate = useNavigate();

  return (
    <div className="contact-page">
      <div className="contact-top-strip">📞 We’re Here to Help</div>

      <section className="contact-hero">
        <div className="contact-hero-icon">✉️</div>
        <div>
          <h1>Contact Us</h1>
          <p>Get in touch with our onboarding team for support and clarification</p>
        </div>
      </section>
      ...
      <div className="contact-grid">
        ...
        <section className="contact-card needhelp-card">
          ...
          <div className="needhelp-body">
            <p className="needhelp-desc">Choose the option that best suits your needs</p>

            {/* BOOK MEETING */}
            <div
              className={`needhelp-option blue clickable ${!isAuth ? "disabled" : ""}`}
              onClick={() => {
                if (isAuth) navigate("/meeting");
              }}
            >
            ...
            <div className="needhelp-option yellow">
              ...
              <div>
                ...
                <button
                  className="email-btn"
                  onClick={() => (window.location.href = "mailto:onboarding@westgateithub.in")}
                >
                  Send Email
                </button>
              </div>
            ...
            <div
              ...
              onClick={() => navigate(isAuth ? "/private-faq" : "/public-faq")}
            >
      ...
      <div className="contact-rest-wrapper">
        ...
        <div className="contact-note">
          <strong>Note:</strong> For urgent matters or escalations, please email directly to{" "}
          <a href="mailto:onboarding@westgateithub.in">onboarding@westgateithub.in</a>{" "}
